...
pca = PCA(n_components = 300, random_state = 1).fit(data_orig_2019)
reduced_data_2019 = pca.transform(data_orig_2019)

data_fwd_2019 = reduced_data_2019[1:, :]
data_bck_2019 = reduced_data_2019[:-1, :]
...
f_name = 'tsred_results_ridge_2019.joblib'
...
# saving alpha_search in a pickle    
f_name = 'stored_objs/tsred_results_mlp_2019_v4.joblib'
joblib.dump(cv_estimator, f_name, compress=3)